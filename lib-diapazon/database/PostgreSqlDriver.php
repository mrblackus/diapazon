...
use Diapazon\Generator\Field;
use Diapazon\Generator\ManyToOne;
use Diapazon\Generator\OneToMany;
use Diapazon\Generator\PrimaryKey;
use Diapazon\Generator\SPParameter;
use Diapazon\Generator\StoredProcedure;
use Diapazon\Generator\StoredProcedureFactory;
...
class PostgreSqlDriver extends Driver
{
    ...
    private function readTables()
    {
        ...
        foreach ($fields as $f)
        {
            ...
            {
                $array = explode($this->DBSchema . '.', $f['sequence_name']);
    ...
    private function readPrimaryKeys(&$tables)
    {
        ...
        WHERE tc.constraint_type = 'PRIMARY KEY' AND tc.constraint_schema = '" . $this->DBSchema . "'");
        $query->execute();
    ...
    private function readCustomStoredProcedures($tables)
    {
        ...
        WHERE
          r.specific_schema = '" . $this->DBSchema . "' AND
